...
export function LandingPage() {
  ...
  return (
    <div style={{ width: '100%', height: '100%', background: bg, overflow: 'hidden', position: 'relative', fontFamily: "'DM Sans',sans-serif" }}>
      ...
      <div
        className="fade-up"
        style={{ position: 'absolute', left: 60, bottom: 118, zIndex: 20 }}
      >
        <h1 style={{
